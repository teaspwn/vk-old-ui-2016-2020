...
[dir] .TopNavBtn.TopNavBtn__audio .TopNavBtn__icon {
    background: url(https://raw.githubusercontent.com/891-2/vk-old-rad/main/icons/logo.png) no-repeat;
    width: 20px;
...
.page_actions_wide.no_actions .page_actions_wrap {
width: 157px;
}
div#react_rootEcosystemServicesNavigationEntry{
display:none;
}
button.im-page-action._im_page_action.im-page-action_pin svg {
background: url("data:image/svg+xml;charset=utf-8,%3Csvg%20height%3D%2212%22%20viewBox%3D%220%200%2012%2012%22%20width%3D%2212%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22m11.8%204.3-4-4c-.1-.1-.2-.1-.3%200%200%200%200%20.1-.1.1l-.4%201.6-.2.2c-1.2%201.2-2.7%201.8-4.3%201.8h-2c-.1%200-.2.1-.2.2s0%20.1.1.1l3%203-2.9%202.9c-.4.4-.4%201%200%201.4s1%20.4%201.4%200l2.9-2.9%202.9%202.9c.1.1.2.1.3%200l.1-.1v-2c0-1.6.6-3.1%201.8-4.3l.1-.2%201.7-.4c.1%200%20.1-.1.1-.3z%22%20fill%3D%22%23828a99%22%2F%3E%3C%2Fsvg%3E") no-repeat;
background-size: 18px;
}
.TopNavBtn.TopNavBtn--messenger {
    display: none;
}
`);
...
function ads() {
    var ad_blocks, a
    ad_blocks = document.querySelectorAll('div#ads_left>div,[data-ad-view],div[data-ad-disabled-stat-impression],div#feed_filters');
...
<style>
       .page_actions_wide_old {
    display: block;
    user-select: none;
}

.page_actions_wide_old_div {
    float: left;
    position: relative;
    width: 157px;
    display: block;
...
.page_actions_wide_old_div_friends {
    font-size: 12.5px;
    zoom: 1;
    cursor: pointer;
    white-space: nowrap;
...
.page_actions_wide_old_div_friends_right {
    float: right;
    position: relative;
}

.page_actions_wide_old_div_friends_div {
    font-size: 12.5px;
    display: inline-block;
    zoom: 1;
    cursor: pointer;
...
.page_actions_wide_old_div_friends_span {
    color: rgb(85, 103, 125);
    padding-right: 13px;
    background-image: url('data:image/svg+xml;base64,');
    background-color: transparent;
    background-position: 100% 7px;
    background-repeat: no-repeat;
}

.page_actions_wide_old_div_friends_div_actions {
    color: rgb(85, 103, 125);
    padding-right: 13px;
    background-image: url('data:image/svg+xml;base64,');
    background-color: transparent;
...
.actions_block_div_span {
    background-image: none;
    background-color: transparent;
    color: rgb(93, 109, 128);
    padding: 0px 13px;
}

.actions_block_div_hidden {
    line-height: 140%;
...
.actions_block_div_hidden a:hover{
    text-decoration: none;
}
.visible {
    opacity:1;
...
a.action_a:hover,a.action_a_a:hover {
    background: var(--steel_gray_40);
}
    ...
    <style>
        ...
        .border {
            border-top-color: rgb(218, 226, 234);
            border-top-style: solid;
        ...
        .dot_act {
            ...
            background-origin: padding-box;
            background-size: auto;
            border-bottom-color: rgb(85, 103, 125);
            border-bottom-left-radius: 4px;
            border-bottom-right-radius: 4px;
            border-bottom-style: none;
            border-bottom-width: 0px;
            ...
            border-image-source: none;
            border-image-width: 1;
            border-left-color: rgb(85, 103, 125);
            border-left-style: none;
            border-left-width: 0px;
            border-right-color: rgba(0, 0, 0, 0);
            border-right-style: solid;
            border-right-width: 8.98455px;
            border-top-color: rgb(85, 103, 125);
            border-top-left-radius: 4px;
            border-top-right-radius: 4px;
            border-top-style: none;
            border-top-width: 0px;
            ...
            padding-top: 7px;
            text-align: center;
            text-decoration-color: rgb(85, 103, 125);
            text-decoration-line: none;
            text-decoration-style: solid;
            vertical-align: top;
            white-space: nowrap;
