...
/* Лайки 2018 */
.PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > .PostButtonReactionsContainer.PostBottomActionContainer > .PostButtonReactions--post.PostButtonReactions.PostBottomAction--withBg.PostBottomAction > ._like_button_icon.PostBottomAction__icon > .PostButtonReactions__icon , .PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > ._reply_wrap._comment.comment.PostBottomAction--withBg.PostBottomAction svg , .PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > ._share.share.PostBottomAction--withBg.PostBottomAction svg {
...
.PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > .PostButtonReactionsContainer.PostBottomActionContainer > .PostButtonReactions--post.PostButtonReactions.PostBottomAction--withBg.PostBottomAction > .PostBottomAction__count--withBg._counter_anim_container._like_button_count.PostBottomAction__count, .PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > .empty._share.share.PostBottomAction--withBg.PostBottomAction, .PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > .empty._reply_wrap._comment.comment.PostBottomAction--withBg.PostBottomAction {
    cursor: pointer;
    color: #2a5885;
    white-space: nowrap;
    overflow: hidden;
...
.PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > .PostButtonReactionsContainer.PostBottomActionContainer > .PostButtonReactions--post.PostButtonReactions.PostBottomAction--withBg.PostBottomAction > ._like_button_icon.PostBottomAction__icon > .PostButtonReactions__icon > svg
{
display: none;
}
/* Реакции OLD */
...
/* Репосты */
.PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > ._share.share.PostBottomAction--withBg.PostBottomAction svg {
...
/* Комментарии */
.PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > ._reply_wrap._comment.comment.PostBottomAction--withBg.PostBottomAction svg {
...
/* FIX */
[dir] .PostBottomAction--withBg {
    border-radius: 0;
}
.PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > ._reply_wrap._comment.comment.PostBottomAction--withBg.PostBottomAction > ._like_button_icon.PostBottomAction__icon > svg g {
display: none;
}
.PostBottomActionLikeBtns--withBgButtons.PostBottomActionLikeBtns.like_cont > .like_btns > ._share.share.PostBottomAction--withBg.PostBottomAction > ._like_button_icon.PostBottomAction__icon > svg > g {
    display: none;
}
